...
+ Inloggnings- och klientkonsol {#login-and-client-console}
...
+ Arbetsflöden {#workflows}
   ...
   + [Öka antalet parallella arbetsflöden](/help/troubleshoot-adobe-campaign/increase-parallel-workflows.md)
   + [Filtrera arbetsflöden genom att behålla resultatvillkoret](/help/troubleshoot-adobe-campaign/keep-result-workflow.md)
...
+ Leveranser och kanaler {#deliveries-and-channels}
   + [Förhindra att inaktiverade meddelanden skickar e-postmeddelanden](/help/troubleshoot-adobe-campaign/disabled-messages-sending-emails.md)
   + [Felsökningsmeddelandet avbröts på grund av ett fel i en leverans](/help/troubleshoot-adobe-campaign/message-cancelled-error.md)
